  ...
  <Menu>
   ...
   >
    {data.length > 0 ? (
     ...
     <MenuItem>
      <button
       className="group text-xs transition-all duration-300 !hover:bg-red-600 text-center capitalize flex w-full items-center gap-2 rounded-lg py-1.5 px-3 text-red-500"
      >
       {errorText}
      </button>
     </MenuItem>
